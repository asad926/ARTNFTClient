...
class itemCardDetail extends Component {
    ...
    createAuction = async () => {
       ...
       if(!res) return;
        ...
        let link = "http://localhost:9000/nfts/update/"+nftId;
        try {
            axios({
                method: "POST",
                url: link,
    ...
    cancelAuction = async () => {
        ...
        let link = "http://localhost:9000/nfts/auction/" + id;
        try {
            axios({
                method: "POST",
                data:{},
    ...
    loadDB = async function () {
        try {
            let nftId = this.props.match.params.id;
            let link = "http://localhost:9000/nfts/" + nftId;
    ...
    bidAuction = async () => {
        ...
        try {
            let link = "http://localhost:9000/nfts/bid/" + id;
